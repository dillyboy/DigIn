...
(function () {
    ...
    routerApp = angular.module("ngAnalytics", []);

    // service to hold viewSelectors, getter, setters, helper
    routerApp.service('ngAnalyticsService', [
        '$timeout',
        function ($timeout) {
            var clientId;
    ...
    routerApp.directive("ngAnalyticsAuth", [
        'ngAnalyticsService',
    ...
    routerApp.directive("ngAnalyticsChart", [
        'ngAnalyticsService',
        function (ngAnalyticsService) {
            return {
                scope: {
    ...
    routerApp.directive("ngAnalyticsReport", [
        '$rootScope',
        '$q',
        'ngAnalyticsService',
    ...
    routerApp.directive("ngAnalyticsView", [
        'ngAnalyticsService',
        function (ngAnalyticsService) {
            return {
                scope: {
