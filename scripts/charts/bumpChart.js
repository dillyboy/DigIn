(function(){
    ...
    var chart = DiginD3.chart()
        .title('Bump Chart')
        .thumbnail("styles/css/images/charts/bumpChart.png")
        .description(
            "For continuous data such as time series, a bump chart can be used in place of stacked bars.")
