(function(){
    ...
    var points = DiginD3.models.points();
    ...
    var chart = DiginD3.chart()
        .title('Convex Hull')
        .description(
            "In mathematics, the <a href='https://en.wikipedia.org/wiki/Convex_hull'>convex hull</a> is the smallest convex shape containing a set o points. Applied to a scatterplot, it is useful to identify points belonging to the same category.")
        .thumbnail("styles/css/images/charts/convexHull.png")
        .model(points)
