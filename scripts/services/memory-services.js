...
(function () {
    ...
    var reports = [
        ...
        findByManager = function (managerId) {
            var results = reports.filter(function (element) {
    ...
    angular.module('routerApp.memoryServices', [])
        .factory('Report', [
            function () {
                return {
                    query: function () {
                    ...
                    get: function (report) {
                        return findById(parseInt(report.employeeId));
                    }
                }
            ...
            function () {
                return {
                    query: function (report) {
                        return findByManager(parseInt(report.employeeId));
                    }
                }
